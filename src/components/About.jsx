...
const About = () => {
    ...
    return (
        <div className="mt-0 bg-gray-50 dark:bg-gray-700 min-h-screen flex flex-col items-center pt-5 pb-10 px-4 sm:px-6 lg:px-10">
            {/* About Section */}
            <motion.div
                initial={{ opacity: 0, y: 40 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
                className="mt-0 bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-7xl w-full px-6 py-8 md:px-8 md:py-10"
            >
                <h1 className="text-3xl md:text-4xl font-extrabold text-center text-gray-800 dark:text-white mb-8 tracking-tight">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    <motion.div
                        ...
                        className="w-full lg:w-1/2 text-gray-700 dark:text-gray-300 text-[15px] md:text-base space-y-4 leading-relaxed"
                    >
                        <p>
            ...
            <section className="mt-20 w-full max-w-7xl">
                <h2 className="text-3xl md:text-4xl font-semibold mb-12 text-center text-gray-800 dark:text-white">
                    Why Shop With Us?
                </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-2 sm:px-6">
                    {facilities.map((item, idx) => (
                        ...
                        >
                            ...
                            <p className="font-semibold text-gray-800 dark:text-white text-lg">{item.title}</p>
