...
const ContactPage = () => {
    ...
    return (
        <section className="py-12 font-sans bg-gray-50">
        <div className="container mx-auto px-4r">
            <h2 className="text-3xl font-bold">Contact Us</h2>
            <p className="text-gray-600">Get in touch with us. We are always here to help you.</p>
        </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                <label className="block mb-1 font-semibold" htmlFor="username">Full Name</label>
                <input
                    type="text"
                    name="username"
                    id="username"
